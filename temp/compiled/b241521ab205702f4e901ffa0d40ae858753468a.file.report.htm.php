<?php /* Smarty version Smarty-3.0.6, created on 2018-04-12 16:15:27
         compiled from "/home/wwwroot/default/dangjian2/temp/dangwei/report/report.htm" */ ?>
<?php /*%%SmartyHeaderCode:15972287465acf159fec1ff9-10517074%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b241521ab205702f4e901ffa0d40ae858753468a' => 
    array (
      0 => '/home/wwwroot/default/dangjian2/temp/dangwei/report/report.htm',
      1 => 1517066265,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15972287465acf159fec1ff9-10517074',
  'function' => 
  array (
  ),
...
<span class="action-span1"><a href=""><?php echo $_smarty_tpl->getVariable('sys_name')->value;?>
 管理中心</a>  - <?php echo $_smarty_tpl->getVariable('page_title')->value;?>
	...
	<span class="action-span"><a href="report.php?action=detail_export&id=<?php echo $_smarty_tpl->getVariable('report')->value['id'];?>
">导出</a></span>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
	  ...
	  <td colspan="6"><input type="text" name="info[title]"  readonly="readonly" value="<?php echo $_smarty_tpl->getVariable('report')->value['title'];?>
" size="48" /></td>
    </tr>
	<tr>
		<td class="label">添加时间<em style="color: red">*</em>：</td>
...
" size="32" />篇</td>
	...
	<?php if ($_smarty_tpl->getVariable('report')->value['attachment']){?>
	<tr>

		<td class="label"><a href="<?php echo $_smarty_tpl->getVariable('url_path')->value;?>
...
" name="id" />
		  <?php $_smarty_tpl->tpl_vars['action'] = new Smarty_Variable($_smarty_tpl->getVariable('action',null,true,false)->value);if ($_smarty_tpl->tpl_vars['action']->value = "do_add_report"){?>
